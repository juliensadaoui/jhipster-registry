...
describe('Event Manager test', () => {
  describe('Event Manager Test', () => {
    let recievedEvent: EventWithContent<string> | string | null;
    ...
    it('should create an observable and callback when broadcasted EventWithContent', inject(
      ...
      (eventManager: EventManager) => {
        // GIVEN
        eventManager.subscribe('modifier', (event: EventWithContent<string>) => (recievedEvent = event));
    ...
    it('should subscribe to multiple events', inject([EventManager], (eventManager: EventManager) => {
      // GIVEN
      eventManager.subscribe(['modifier', 'modifier2'], (event: EventWithContent<string>) => (recievedEvent = event));
